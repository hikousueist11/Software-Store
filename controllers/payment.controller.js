...
module.exports.makeOrder = async (req, res) => {
    ...
    // send Email
    // const orderHTML = toolFunctions.makeOrderInforToEmail(req.body, order)
    // const cartHTML = toolFunctions.makeCartToEmail(editedCart)
    // const contentHTML = orderHTML + cartHTML
    // toolFunctions.sendOrderToEmail(process.env.email, contentHTML)
}
