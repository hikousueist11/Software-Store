...
const addProductInCart = (category, productID) => {
    ...
    // const attribute = getAttributeByCategory(category);
    // const customizedAttribute = customizeAttribute(category, attribute)
    // const model = document.querySelectorAll("#pathsBox > a")[2].innerText
    ...
    productEles.forEach((li, index) => {
        ...
        // const productAttribute = li.querySelector(".Navigation__cartProductInfo span").innerText
        // if(productName === name && productAttribute === customizedAttribute) duplicatedProductIndex = index
